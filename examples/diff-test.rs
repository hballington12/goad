...
fn main() {
    ...
    let m11: Complex<f64> = Complex::new(0.5, 0.25);
    let m12: Complex<f64> = Complex::new(0.25, -0.45);
    let m21: Complex<f64> = Complex::new(0.85, 0.2);
    let m22: Complex<f64> = Complex::new(-0.5, 0.5);
    let ampl = Matrix2::new(m11, m12, m21, m22);
    let prop: Vector3<f64> = Vector3::new(0.0, 0.5, -0.9).normalize();
    let vk7: Vector3<f64> = Vector3::new(1.0, 0.0, 0.0);
